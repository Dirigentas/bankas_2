        ...
        <div style="display:flex; justify-content: space-between; flex-direction: column; gap: 10px; border: solid 3px skyblue">
            <?php foreach ($ibans as $iban) : ?>
                <h6 style="display:flex; justify-content: space-between; border-bottom: dashed 2px skyblue; flex-wrap: wrap; gap: 5px; padding: 3px">
                    ...
                    <a class="col-12 col-sm-12 col-md-5 col-lg-2 col-xl-1" href="http://localhost/bankas_1/php/add_funds.php?ID=<?= $iban['ID'] ?>">Pridėti lėšų</a>
                    <a class="col-12 col-sm-12 col-md-5 col-lg-2 col-xl-1" href="http://localhost/bankas_1/php/withdraw_funds.php?ID=<?= $iban['ID'] ?>">Nuskaičiuoti lėšas</a>
